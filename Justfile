...
packages := "extest lsfg-vk armada-splash armada-rgb armada-bottom-touchpads inputplumber fex mesa mesa-android mesa-x86 mangohud gamescope gamescope-session kwin plasma-mobile powerdevil networkmanager jupiter-hw-support umtp-responder kernel"
